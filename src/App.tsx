...
<h1
  className="text-5xl sm:text-6xl lg:text-6xl xl:text-7xl font-bold text-white leading-[1.18] pb-3 animate-slide-up"
  style={{ animationDelay: '0.4s', opacity: 0 }}
>
  <span className="block mb-2">Professional</span>

  <span className="block mb-2 bg-gradient-to-r from-green-400 to-green-200 bg-clip-text text-transparent">
